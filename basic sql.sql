...
*/
select id, account_id, standard_amt_usd/standard_qty as UnitPriceOfStandardPaper
from orders
limit 10;
...
select id, account_id, poster_amt_usd/total_amt_usd as posterRev 
from orders
limit 10;
...
data for all orders where gloss_qty is between 24 and 29. Then look at your 
...
contacted via the organic or adwords channels, and started their account at any point in 2016, sorted from newest to oldest.
*/
SELECT *
FROM web_events
